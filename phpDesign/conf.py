...
htmlhelp_basename = 'AcanstudioDocsdoc'
latex_documents = [
    ('index', 'AcanstudioDocs.tex', u'Acanstudio Docs Documentation',
     u'Eric Holscher, Charlie Leifer, Bobby Grace', 'manual'),
]
man_pages = [
    ('index', 'read-the-docs', u'Acanstudio Docs Documentation',
